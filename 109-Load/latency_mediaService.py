...
def run_load():
    commandToRunLoad1 = "../wrk2/wrk -D exp -t 1 -c 32 -d 60s -L -s ./wrk2/scripts/media-microservices/compose-review.lua http://10.89.3.7:8080/wrk2-api/review/compose -R 2500"
    ...
    process1 = subprocess.Popen(commandToRunLoad1, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, cwd="../mediaMicroservices")
...
def run_load_qos():
    commandToRunLoad1 = "../wrk2/wrk -D exp -t 1 -c 32 -d 300s -L -s ./wrk2/scripts/media-microservices/compose-review.lua http://10.89.3.7:8080/wrk2-api/review/compose -R 3500"
    commandToRunLoad2 = "../wrk2/wrk -D exp -t 1 -c 32 -d 30s -L -s ./wrk2/scripts/media-microservices/compose-review.lua http://10.89.3.7:8080/wrk2-api/review/compose -R 7000"
    ...
    process2 = subprocess.Popen(commandToRunLoad2, shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, cwd="../mediaMicroservices")
...
def create_latency_graph(data, tamp):
    ...
    filename = f"ms_{tamp}_latency.png"
...
def create_tail_latency_graph(tamp):
    ...
    plt.grid(True)
    filename = f"ms_{tamp}_tail_latency.png"
