...
def run_load():
    commandToRunLoad1 = "../wrk2/wrk -D fixed -t 1 -c 16 -d 60s -L -s ./wrk2/scripts/media-microservices/compose-review.lua http://10.89.3.7:8080/wrk2-api/review/compose -R 3000"
