...
def run_load():
    commandToRunLoad1 = "../wrk2/wrk -D fixed -t 1 -c 32 -d 120s -L -p -s ./wrk2/scripts/social-network/compose-post.lua http://10.89.3.7:8080/wrk2-api/post/compose -R 4500"
